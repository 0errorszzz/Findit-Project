...
import { NotFoundError, BadRequestError, UnauthenticatedError, UnauthorizedError } from '../errors/customError.js';
...
export const validateJobId=withValidationErrors([
    ...
    .custom(async(value,{req})=>{
        ...
        if(!isAdmin&&!isOwner) throw new UnauthorizedError('not authorized to access this job')
    })
])
...
export const validateRegisterInput=withValidationErrors([
    ...
    .isEmail().withMessage('invalid email').custom(async(email)=>{
